        ...
        playerCard.innerHTML = `
            <div class="player-info">
                ...
                <div class="stat-tabs" id="tabs-${cardId}">
                    ...
                    <button class="stat-tab" data-tab="advanced" onclick="app.switchTab(event, '${cardId}', 'advanced', ${player.id})">Advanced ⚡</button>
                </div>
